function [sp, p, noise_var] = mle_sto_uc_2d_joint_ground(R_all, n, design_all, ...
  wavelength, geom, x0, latlon, varargin)
%MLE_STO_UC_2D_JOINT_GROUND Multi-array ML estimator (stochastic model,
...
num_theta = 2*n;   % Reference array 2D LAT-LONs: [lat1; lon1; ...; latn; lonn]
