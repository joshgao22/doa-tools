function sp = mvdr_2d(R, n, design, wavelength, grid_size, varargin)
%MVDR_1D 1D MVDR beamforming.
%Syntax:
%   sp = MVDR_2D(R, n, design, wavelength, grid_size, ...);
%   sp = MVDR_2D(R, n, f_steering, [], grid_size, ...);
%Inputs:
...
[x_est, x_est_idx, resolved] = find_doa_from_spectrum(doa_grid_display, sp_intl, n);
% refine
