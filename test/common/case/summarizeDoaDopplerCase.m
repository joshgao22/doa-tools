...
info.runTimeMs = 1e3 * localGetOptimField(estResult, 'runTimeSec', NaN);
info.funcCount = localGetOptimField(estResult, 'funcCount', NaN);
info.iterations = localGetOptimField(estResult, 'iterations', NaN);
end
