...
fieldList = { ...
  ...
  'sameToothRescueEnable', ...
  'sameToothRescueCoherenceThreshold', ...
  'sameToothRescuePhaseResidThresholdRad', ...
  'sameToothRescueBankMode', ...
  'sameToothRescueWideDoaHalfWidthDeg', ...
  'sameToothRescueSingleDoaHalfWidthDeg', ...
  'sameToothRescueMultiDoaHalfWidthDeg', ...
...
summary.usedBasinEntryRescue = logical(localGetFieldOrDefault(periodicDoaSeed, 'usedBasinEntryRescue', false));
summary.basinEntryRescueTriggered = logical(localGetFieldOrDefault(periodicDoaSeed, 'basinEntryRescueTriggered', false));
summary.basinEntryRescueSelected = logical(localGetFieldOrDefault(periodicDoaSeed, 'basinEntryRescueSelected', false));
summary.basinEntryGateReason = string(localGetFieldOrDefault(periodicDoaSeed, 'basinEntryGateReason', "unknown"));
summary.basinEntryCandidateCount = localGetFieldOrDefault(periodicDoaSeed, 'basinEntryCandidateCount', 0);
