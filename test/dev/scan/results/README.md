...
| `scanMfMsMleCrbCleanBoundConsistency.m` | `scanMfMsMleCrbCleanBoundConsistency.md` | `paper-facing / controlled-local` | CleanTrim 固定成 truth-centered clean-bound MLE-vs-CRB scan，纳入 SS/MS、CP/IP、K/U，并允许按 range profile 精细指定 DoA-CRB 倍数和 fd 范围；结果必须解释为 oracle local-bound 条件。 |
